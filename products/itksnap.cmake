...
IF(${CONFIG_EXT} MATCHES ".*qt4.*")
  ...
  SETCOND(SKIP_BUILD ON BRANCH vtk_render)
...
ELSE(${CONFIG_EXT} MATCHES ".*qt4.*")
  ...
  SETCOND(NEED_QT515 ON BRANCH "vtk_render")
...
CACHE_ADD("ITK_DIR:PATH=${ROOT}/Nightly/itk/v5.1.2/${CONFIG_BASE}" BRANCH "vtk_render")
