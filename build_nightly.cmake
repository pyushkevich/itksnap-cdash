...
SET (CTEST_SOURCE_DIRECTORY "${ROOT}/nightly/itksnap")
SET (CTEST_BINARY_DIRECTORY "${ROOT}/nightly/${CONFIG}")
...
SET (CTEST_COMMAND 
  "${CTEST_CTEST_COMMAND} -M Nightly -T Start -T Update -T Configure -T Build -T Test -T Submit"
...
IF(NOT SKIP_UPLOAD)
  SET (CTEST_COMMAND ${CTEST_COMMAND} 
    "${CTEST_MAKE_COMMAND} upload_nightly")
ENDIF()
