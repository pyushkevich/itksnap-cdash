...
IF(NEED_QT4)
  ...
  SETCOND(QT4DIR "/mnt/build/pauly/Qt/qt-4.8.2" CONFIG gcc64rel)
  CACHE_ADD("QT_QMAKE_EXECUTABLE:FILEPATH=${QT4DIR}/bin/qmake")
ENDIF(NEED_QT4)

IF(NEED_QT5)
  SETCOND(QT5DIR "/home/picsl/Qt/5.3/gcc_64" CONFIG gcc64rel)
  SETCOND(SKIP_BUILD ON CONFIG gcc32rel)
  CACHE_ADD("CMAKE_PREFIX_PATH:FILEPATH=${QT5DIR}/lib/cmake" PRODUCT "itksnap" BRANCH "dev32")
ENDIF(NEED_QT5)
