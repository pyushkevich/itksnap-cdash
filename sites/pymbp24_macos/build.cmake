...
# SETCOND(SKIP_BUILD ON PRODUCT "itksnap")
SETCOND(SKIP_BUILD ON PRODUCT "c3d" CONFIG "xc64dbg")
SETCOND(SKIP_BUILD ON PRODUCT "greedy" CONFIG "xc64dbg")
SETCOND(SKIP_BUILD ON PRODUCT "cmrep" CONFIG "xc64dbg")

# ENV_ADD(MAKEFLAGS "-j 18")
ENV_ADD(CMAKE_BUILD_PARALLEL_LEVEL 18)
...
CACHE_ADD("CMAKE_OSX_DEPLOYMENT_TARGET:STRING=12.6")
...
IF(NEED_QT6)
  CACHE_ADD("CMAKE_PREFIX_PATH:FILEPATH=/Users/pauly/Qt/6.9.3/macos/lib/cmake")
ENDIF()
